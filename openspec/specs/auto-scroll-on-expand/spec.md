...
Defines requirements for automatic and programmatic scrolling to expanded/collapsed items in the masonry layout's column mode. Ensures toggled items are visible after expand/collapse state changes.
